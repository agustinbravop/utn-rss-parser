// Generated from C:/Users/anbra/Desktop/UTN/2doNivel/Sintaxis y Semántica de los Lenguajes/RSSParser/RSSParser/src/java/antlr4_files\RSSLexer.g4 by ANTLR 4.10.1
...
public class RSSLexer extends Lexer {
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                "COMMENT", "WS", "URL", "INT", "TXT", "PROTOCOL", "LOGIN", "DOM", "PORT",
                "ROUTE", "QUERY", "FRAG", "QUERY_PARAM", "URL_STR", "O_RSS", "O_CHANNEL",
                "O_IMG", "O_ITEM", "O_TITLE", "O_DESC", "O_LINK", "O_CATEG", "O_COPYR",
                "O_URL", "O_HEIGHT", "O_WIDTH", "C_RSS", "C_CHANNEL", "C_IMG", "C_ITEM",
                "C_TITLE", "C_DESC", "C_LINK", "C_CATEG", "C_COPYR", "C_URL", "C_HEIGHT",
                "C_WIDTH", "RSS_VERSION", "OPEN_XML", "CLOSE_XML", "XML_WS", "ATT_VERSION",
