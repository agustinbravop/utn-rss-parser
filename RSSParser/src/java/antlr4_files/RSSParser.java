...
public class RSSParser extends Parser {
	...
	public static final int
		...
		OPEN_XML=30, CLOSE_XML=31, ATT_VER=32, ATT_ENC=33, EQUALS=34, XML_WS=35, 
		XML_VERSION=36, XML_ENCODING=37;
	public static final int
		...
		RULE_url = 14, RULE_height = 15, RULE_width = 16;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "'<?xml'", "'?>'", "'version'", "'encoding'", 
			"'='"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OPEN_XML", "CLOSE_XML", "ATT_VER", "ATT_ENC", "EQUALS", "XML_WS", "XML_VERSION", 
			"XML_ENCODING"
		};
	}
	...
	public static class Xml_versionContext extends ParserRuleContext {
		public TerminalNode ATT_VER() { return getToken(RSSParser.ATT_VER, 0); }
		public TerminalNode EQUALS() { return getToken(RSSParser.EQUALS, 0); }
	...
	public static class Xml_encodingContext extends ParserRuleContext {
		public TerminalNode ATT_ENC() { return getToken(RSSParser.ATT_ENC, 0); }
		public TerminalNode EQUALS() { return getToken(RSSParser.EQUALS, 0); }
